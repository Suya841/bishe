        ...
        <div class="file-list">
          <!-- <section class="file-item draggable-item" v-for="(item,index) in files" :key="index"> -->
                  <div class="add">
                    <!-- <span>+</span> -->
                    <div class="ico">
                        <div class="iconImg"><img src="http://i2.bvimg.com/686721/2019260df68d36abs.png" alt=""></div><p>图片</p>
                    </div>
                    <!-- accept="image/jpeg,image/png" capture="camera" -->
                    <input type="file" @change="selectImgs()" multiple accept="image/*" ref="file" :disabled="this.files.length >= 9">
                  </div>
    ...
    initPhotoSwipeFromDOM(gallerySelector) {
      var parseThumbnailElements = function(el) {
        var thumbElements = el.childNodes,
          ...
          size,
          item;
        for (var i = 0; i < numNodes ; i++) {  //numNodes-1
